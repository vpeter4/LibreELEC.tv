...
dummy_post_unpack() {
  ...
  wget -O ${SOURCES}/go-pear.phar https://github.com/pear/pearweb_phars/blob/master/go-pear.phar?raw=true
  cp ${SOURCES}/go-pear.phar $PHP_BUILD_DIR/pear/go-pear.phar
